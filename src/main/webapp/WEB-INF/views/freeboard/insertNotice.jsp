...
<script defer type="text/javascript" src="../js/NoticeUpload.js"></script>
...
<div class="container">
	...
	<!-- 중간영역 -->
	<div class="main">
		<form action="insertNoticeOK" method="post" enctype="multipart/form-data" onsubmit="return insertCheck()">
			<table class="table table-sm"
				style="width: 800px; margin-left: auto; margin-right: auto; vertical-align: middle; border: 1px solid #bfbfbf;">
				<tr>
					<th colspan="2" style="font-size: 20pt; text-align: center; background: lavender;">
						공지글
					</th>
				</tr>
				<!-- 이름입력 -->

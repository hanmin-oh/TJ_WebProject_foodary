...
<body onload = "showNutrient()">
	...
	<div class="main" style="text-align: center;" align="center">
		...
		<span style="background: #fafcd9; font-size: 40pt; font-weight: 900;">Foodary 쓰기</span>
		
		<form action="dietInsert" method="post" enctype="multipart/form-data" onsubmit="return insertCheck()">
	      <div class="diet">
	      <!-- 음식 검색 버튼 -->
	     ...
	     <!-- 시간 입력 -->
	      	...
	      	<!-- 사진 첨부 -->
		   	<tr class="text-center">
				<td style="font-size: 20pt; text-align: center; width: 200px;">
					<label for="picture"><span style="background: lavender; font-size: 25pt;">사진첨부</span></label>
				</td>
				<td>
			...
			<tr>
				<td style="font-size: 18pt; text-align: center;">
					<span style="background: lavender; font-size: 25pt;">미리보기</span>
				</td>
				<td align="left">
	      ...
	      <tr style="height: 20px;"></tr> <!-- 공백 -->
	          ...
	          <div class="text-center">
	             ...
	             <button type="reset" style="background: none; border: 0; cursor: pointer;">
	             	 <span style="background: #fafcd9; font-size: 30pt; font-weight: 900;">다시쓰기</span>
	             </button>
	             &nbsp;&nbsp;&nbsp;&nbsp;
